...
5. gunakan API open router -- cari model ai yg free (done - pake model AI LLM)
...
1. Buat HTML, CSS, dan JavaScript dalam repositori (index.html) berdasarkan konsep Canva
Status: ✅ TERPENUHI
...
2. Buat akun Google Cloud Platform yang terverifikasi dan dapat digunakan untuk deployment
...
3. Pelajari JavaScript Core Root dan Go/C Root
...
4. Pelajari CI/CD dari GitHub ke Google Cloud Function
...
5. Gunakan API OpenRouter atau model AI gratis
...
8. Memahami dan menerapkan konsep Explainable AI
